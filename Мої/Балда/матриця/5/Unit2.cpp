...
//---------------------------------------------------------------------------
void T_Balda::Again(const int &n,const int &m,const char *w)
{
    if(w)
    {
        Delete();
...
//---------------------------------------------------------------------------
void T_Balda::SaveToFile(ofstream &ofs)
{
    int i,j;
    ofs<<N<<' '<<M<<endl;
    for(i=0;i<N;++i)
    {
        for(j=0;j<M;++j)
        {
            if(Element[i][j].Symbol==' ')
            {
                ofs<<'_';
            }
            else
            {
                ofs<<Element[i][j].Symbol;
            }
        }
        ofs<<endl;
    }
...
//---------------------------------------------------------------------------
void T_Balda::LoadFromFile(ifstream &ifs)
{
    int i,j;
    Delete();
    ifs>>N>>M;
    ...
    for(i=0;i<N;++i)
    {
        ...
        for(j=0;j<M;++j)
        {
            ifs>>Element[i][j].Symbol;
            if(Element[i][j].Symbol=='_')
            {
                Element[i][j].Symbol=' ';
            }
        }
...
//---------------------------------------------------------------------------
T_SearchWordsByAdding& T_SearchWordsByAdding::
    operator = (const T_SearchWordsByAdding &SWBA)
{
    if(this!=&SWBA)
    {
        Word=SWBA.Word;
