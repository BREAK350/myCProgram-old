...
//---------------------------------------------------------------------------
void CreateModel::CreateGraf()
{
    grf=_CreateGraf(n_point);
}
//---------------------------------------------------------------------------
void CreateModel::CreateLine(int point1,int point2)
{
    _CreateLine(grf,point1,point2);
}
//---------------------------------------------------------------------------
void CreateModel::DeleteLine(int point1,int point2)
{
    _DeleteLine(grf,point1,point2);
}
//---------------------------------------------------------------------------
int CreateModel::isLine(int point1,int point2)
{
...
//---------------------------------------------------------------------------
Point3D Change::TurnOX(Point3D p)
{
    p.TurnOX(loc.alpha);
    return p;
}
//---------------------------------------------------------------------------
Point3D Change::TurnOY(Point3D p)
{
    p.TurnOY(loc.alpha);
    return p;
}
//---------------------------------------------------------------------------
Point3D Change::TurnOZ(Point3D p)
{
    p.TurnOZ(loc.alpha);
    return p;
}
//---------------------------------------------------------------------------
void Change::CreateCHP()
{
    int i;
    free(chp);
...
//---------------------------------------------------------------------------
void ShowForm::ShowCHP(location l)
{
    int i,j;
    for(i=1;i<=n_point;i++)
    {
