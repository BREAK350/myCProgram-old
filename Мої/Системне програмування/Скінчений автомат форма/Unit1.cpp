...
//---------------------------------------------------------------------------
void __fastcall TFormRegularExpression::BitBtn1Click(TObject *Sender)
{
    // check regular expression
    if(RegChanges && RegularExp->Text.Length()>0)
    {
        UFA.Create(RegularExp->Text.c_str());
        DFA.CreateFrom(UFA);
        MDFA=DFA;
        MDFA.Minimize();
        if(Undetermined->Checked)
        {
            ShowUFA();
        }
        else
        if(Determined->Checked)
        {
            ShowDFA(DFA);
        }
        else
...
//---------------------------------------------------------------------------
void __fastcall TFormRegularExpression::UndeterminedClick(TObject *Sender)
{
    ShowUFA();
}
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
void __fastcall TFormRegularExpression::DeterminedClick(TObject *Sender)
{
    ShowDFA(DFA);
}
//---------------------------------------------------------------------------
void __fastcall TFormRegularExpression::MinimizedClick(TObject *Sender)
{
    ShowDFA(MDFA);
}
//---------------------------------------------------------------------------
...
void __fastcall TFormRegularExpression::BitBtn3Click(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TFormRegularExpression::BitBtn4Click(TObject *Sender)
{
    FormAnimation->Show();    
}
//---------------------------------------------------------------------------
