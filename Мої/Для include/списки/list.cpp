...
//---------------------------------------------------------------------------
void push_back(TList &list,int v)
{
 if(list.last)
 {
...
void push_forward(TList &list,int v)
{
 if(list.first)
 {
  list.first->prev=(TListItem*)malloc(sizeof(TListItem));
  list.first->prev->value=v;
...
void PrintList(TList list,int k)
{
   int         i=0;
   TListItem   *t;
 t=list.first;
